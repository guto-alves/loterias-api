...
@Document("resultados")
@JsonPropertyOrder({ "loteria", "nome", "concurso", "data", "local", "dezenas", 
	"premiacoes", "acumulado", "acumuladaProxConcurso", "dataProxConcurso", 
	"proxConcurso", "timeCoracao", "mesSorte" })
